...
public class Lesson7NewAdventure implements IAdventureGame {
  ...
  // Creatures
  private final Creature fluffy = new Creature("Fluffy", "A cute little guinea pig, black and brown and a little bit white.");
  private final Creature cotton = new Creature("Cotton", "A cute little guinea pig, four-colored one.");
  private final Creature cloudy = new Creature("Cloudy", "A cute little guinea pig, white and a little bit brown.");
  
  private final Creature rocky = new Creature("Rocky", "A chicken. Somewhat brownish with gray on her head.");
  private final Creature snowflake = new Creature("Snowflake", "A chicken. White, with a little brown patch on the head.");
  private final Creature syrup = new Creature("Syrup", "A chicken, black and brown.");
  private final Creature sirchirps = new Creature("Sir Chirps", "A chicken, black and brown.");
